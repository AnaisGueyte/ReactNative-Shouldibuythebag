...
class ReallyOneTimeUseQuestionScreen extends React.Component {
  ...
  state = {
    quest:  "Oh, really? So will you still wear it next month, next season, next year?"
  }
    ...
    return (
      <Container style={styles.quizz}>
        ...
        <Container style={styles.button}>
            ...
            <Button bordered success style={{justifyContent: 'center', width: 85, height: 70, marginLeft: 20}} onPress={ () => navigate('SaleQuestion', { item: this.props.navigation.state.params.item} ) } ><Text style={{color: 'green'}}>Yes</Text></Button>
...
export default ReallyOneTimeUseQuestionScreen;
