...
class OnlineShoppingReturnEasyQuestionScreen extends React.Component {
  ...
  state = {
    quest:  "Can you return the item easily if it doesn't fit?"
  }
    ...
    return (
      <Container style={styles.quizz}>
        ...
        <Container style={styles.button}>
            ...
            <Button bordered success style={{justifyContent: 'center', width: 85, height: 70, marginLeft: 20}} onPress={ () => navigate('OwnQuestion',  {item: this.props.navigation.state.params.item} ) } ><Text style={{color: 'green'}}>Yes</Text></Button>
  </Container>
      </Container>
        );
    }   
...
export default OnlineShoppingReturnEasyQuestionScreen;
