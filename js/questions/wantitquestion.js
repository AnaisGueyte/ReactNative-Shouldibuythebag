...
class WantItQuestionScreen extends React.Component {
    ...
    return (
     <Container style={styles.quizz}>
        ...
        <Container style={styles.button}>
            ...
            <Button bordered success style={{justifyContent: 'center', width: 85, height: 70, marginLeft: 20}} onPress={ () => navigate('QualityQuestion',  {item: this.props.navigation.state.params.item}) } ><Text style={{color: 'green'}}>Yes</Text></Button>
        </Container>
      </Container>
        );
    }   
...
export default WantItQuestionScreen;
