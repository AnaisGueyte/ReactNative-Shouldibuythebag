...
class OwnQuestionScreen extends React.Component {
  ...
  state = {
    quest:  "Do you already own something similar?"
  }
       ...
       <View style={styles.bannerView}><Image style={styles.banner} source={imgBanner}></Image></View>
        ...
        <View style={styles.itemsBackground}>
          ...
          <View style={styles.button}>
            ...
            <Button bordered danger style={{justifyContent: 'center', width: 85, height: 70, marginRight: 20}} onPress={ () => navigate('TooManyQuestion',  {item: this.props.navigation.state.params.item} ) }><Text style={{color: 'red'}}>No</Text></Button>
...
export default OwnQuestionScreen;
