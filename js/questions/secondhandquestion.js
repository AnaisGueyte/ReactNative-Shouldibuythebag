       ...
       <View style={styles.bannerView}><Image style={styles.banner} source={imgBanner}></Image></View>
        ...
        <View style={styles.itemsBackground}>
          ...
          <View style={styles.button}>
            ...
            <Button bordered danger style={{justifyContent: 'center', width: 85, height: 70, marginRight: 20}} onPress={ () => navigate('PriceQuestion', { item: this.props.navigation.state.params.item} ) }><Text style={{color: 'red'}}>No</Text></Button>
            <Button bordered success style={{justifyContent: 'center', width: 85, height: 70, marginLeft: 20}} onPress={ () => navigate('SecondHandOnlineQuestion', { item: this.props.navigation.state.params.item} ) } ><Text style={{color: 'green'}}>Yes</Text></Button>
...
export default SecondHandQuestionScreen;
