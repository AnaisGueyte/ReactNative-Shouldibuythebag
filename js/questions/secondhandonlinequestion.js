...
class SecondHandOnlineQuestionScreen extends React.Component {
  ...
  state = {
    quest:  "Can you find it on Poshmark?",
    under_question: 'Or Twice, Snobswap, TheRealReal, Vinted, Vestiaires Collectives (you name it)'
  }
     ...
     <Container style={styles.quizz}>
        ...
        <Container style={styles.question_container}>
          ...
          <Container style={styles.button}>
            ...
            <Button bordered success style={{justifyContent: 'center', width: 85, height: 70, marginLeft: 20}} onPress={ () => navigate('PriceQuestion', { item: this.props.navigation.state.params.item } ) } ><Text style={{color: 'green'}}>Yes</Text></Button>
...
export default SecondHandOnlineQuestionScreen;
