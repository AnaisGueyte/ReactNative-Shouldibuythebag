...
class InfluencerWearQuestionScreen extends React.Component {
  ...
  state = {
    quest:  "Would you still buy it if that Influencer wasn't wearing it?"
  }
    ...
    return (
       <Container style={styles.quizz}>
        ...
        <Container style={styles.button}>
            ...
            <Button bordered success style={{justifyContent: 'center', width: 85, height: 70, marginLeft: 20}} onPress={ () => navigate('OneTimeUseQuestion', { item: this.props.navigation.state.params.item} ) } ><Text style={{color: 'green'}}>Yes</Text></Button>
...
export default InfluencerWearQuestionScreen;
